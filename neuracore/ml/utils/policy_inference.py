...
from neuracore.ml.utils.mar import load_model_from_mar
...
class PolicyInference:
    ...
    def __init__(
        ...
        self.org_id = org_id
        self.job_id = job_id
        self.model = load_model_from_mar(mar_file)
    ...
    def _preprocess(self, sync_point: SyncPoint) -> BatchedInferenceSamples:
        ...
        Converts a single SyncPoint data into batched tensors suitable for model inference.
        Handles multiple data modalities including joint states, images, and language instructions.
