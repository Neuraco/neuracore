...
class ClientConsumerStreamManager(BaseP2PStreamManager):
    ...
    def __init__(
        ...
        robot_instance: int,
        local_stream_id: str,
        current_track_information: AvailableRobotInstance,
        ...
        self.streaming = EnabledManager(True, loop=self.loop)
    ...
    @property
    def current_track_information(self) -> AvailableRobotInstance:
    ...
    def current_track_information(
        self, current_track_information: AvailableRobotInstance
    ) -> None:
    ...
    async def _get_ice_config(self) -> IceConfig:
        ...
        self.ice_config = IceConfig.model_validate_json(await response.json())
