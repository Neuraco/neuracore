...
class BaseStreamManagerFactory(ABC):
    """Base class for a factory that creates stream managers."""

    @abstractmethod
    def get_manager(
        self, type: ManagerType, robot_id: str, instance: int
    ...
    @abstractmethod
    def remove_manager(
        self, robot_id: str, instance: int, type: Optional[ManagerType] = None
    ) -> None:
