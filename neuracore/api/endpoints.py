...
from ..core.endpoint import launch_policy_direct as _launch_policy_direct
from ..core.endpoint import launch_policy_local_server as _launch_policy_local_server
from ..core.endpoint import launch_policy_remote_server as _launch_policy_remote_server
...
def launch_policy_direct(
    ...
    """
    return _launch_policy_direct(train_run_name, model_file, robot_name, instance)
...
def launch_policy_local_server(
    ...
    """Launch a local server policy with a custom FastAPI server.

    This option provides server-like architecture while maintaining local control.
    Uses a lightweight FastAPI server instead of TorchServe for better flexibility.
    ...
    Raises:
        ...
        ConfigError: If there is an error trying to get the current org.
    """
    return _launch_policy_local_server(train_run_name, port, robot_name, instance, host)
...
def launch_policy_remote_server(
    ...
    Raises:
        ...
        ConfigError: If there is an error trying to get the current org.
    """
    return _launch_policy_remote_server(endpoint_name, robot_name, instance)
